...
function build() {
    ...
    mkdir -p ~/qjs/Lib/Android/${ABI}/
    cp ${BUILD_PATH}/libquickjs.a ~/qjs/Lib/Android/${ABI}/libquickjs.a
}
...
mkdir ~/qjs/Lib/Android/arm64/
mkdir ~/qjs/Lib/Android/armv7/
mv ~/qjs/Lib/Android/arm64-v8a/libquickjs.a ~/qjs/Lib/Android/arm64/
mv ~/qjs/Lib/Android/armeabi-v7a/libquickjs.a ~/qjs/Lib/Android/armv7/
